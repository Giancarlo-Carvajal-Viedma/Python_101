...
def run_choice(choice:int, course: Course):
    if choice ==0:
        ...
        new_teacher=Teacher("Madeleine","EC","madde@ec.se",["Teaching","Talking","Guiding"])
...
def main():
    ...
    while True:
        ...
        choice_string = input("Välj ett alternativt: ")
        try:
...
main ()
# Föreläsning 6: Goodie bag med repetition, 2023-01-18 07:15 (20230118_081528)